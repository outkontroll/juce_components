...
public:
    ...
    std::function<void(bool, AnimationType)> onClick;
...
private:
    ...
    struct Animating
    {
        ...
        struct Translating
        {
            float originalOffsetX = 0.0;
            float originalOffsetY = 0.0;
            float finalOffsetX = 0.0;
            float finalOffsetY = 0.0;
        };

        std::variant<Rotating, Scaling, Translating> type;
    };
